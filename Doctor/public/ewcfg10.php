...
define("EW_PROJECT_ID", "{AC1E48A3-8A06-46C6-A848-8ACFB1B7C356}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", '5sxe96Re9U0PP5PT', TRUE); // Random key for encryption
...
define("EW_CONN_PASS", 'MSiaas!', TRUE);
define("EW_CONN_DB", 'test', TRUE);
